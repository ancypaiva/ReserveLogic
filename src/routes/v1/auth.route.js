...
router.post('/refresh-menu', validate(authValidation.refreshMenu), authController.refreshMenu);
...
router.post('/profile-edit', validate(authValidation.profileEdit), authController.profileEdit);
router.post('/toggle-change', authController.toggleChange);
